...
__decorate([
    (0, common_1.Get)('/layers/:layerName'),
    __param(0, (0, common_1.Param)('layerName')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], GeoServerController.prototype, "getLayerData", null);
GeoServerController = __decorate([
    (0, common_1.Controller)('geoserver'),
    __metadata("design:paramtypes", [geoserver_service_1.GeoServerService])
], GeoServerController);
