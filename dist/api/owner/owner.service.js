...
const owner_entity_1 = require("./data/owner.entity");
let OwnerService = class OwnerService {
    ...
    async updateOwnerInformation(ownerUpdateDto, ownerId) {
...
OwnerService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(owner_entity_1.Owner)),
